...
def createMiniTools(arguments):
    ...
    if choice == 'monsters' or choice == 'alphabet' or choice == 'letter' or choice == 'right' or choice == 'left' or choice == 'monsterStats' or choice == 'cr' or choice == 'search' or choice == 'crNumbers' or choice == 'monstCRRight' or choice == 'monstCRLeft' or choice == 'monstDesc' or choice == 'searchMonst' or choice == "rightSearch" or choice == "leftSearch":
